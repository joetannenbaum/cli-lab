...
class PhpNycClosingRenderer extends Renderer
{
    use Aligns;
    use DrawsArt;
    use DrawsHotkeys;
    ...
    public function __invoke(PhpNycClosing $prompt): string
    {
        return $this->minDimensions(fn () => $this->renderMessage($prompt), 20, 20);
    }

    protected function renderMessage(PhpNycClosing $prompt): self
    {
